...
// Sibling /files/shares/new exists, so /files/shares is auto-derived
// as a parent layout. Parent (shares.tsx) is now Outlet-only; this
// file is the index that lists shares.
// NOTE: do NOT wrap in userPage() — parent layout owns the chrome.
