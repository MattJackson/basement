...
import { useGetCluster } from "@/shared/api/queries";
        ...
        <section className="space-y-4 rounded-lg border bg-card p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="grid gap-2">
              ...
              <Input id="adminUrl" value={adminUrl} onChange={(e) => setAdminUrl(e.target.value)} disabled={updateCluster.isPending} placeholder="http://garage:3903" />
            </div>
            <div className="grid gap-2">
      ...
      {(driver === "garage-v1" || driver === "garage") && (
        <section className="space-y-4 rounded-lg border bg-card p-6">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              S3 endpoint + cred — required for object browsing, upload, download, and presign.
              Without this, /files/{`{cid}`}/b/{`{bid}`} can't list objects.
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="grid gap-2">
              <Label htmlFor="s3Url">S3 URL</Label>
              <Input id="s3Url" value={s3Url} onChange={(e) => setS3Url(e.target.value)} disabled={updateCluster.isPending} placeholder="http://garage:3902" />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="s3Region">S3 Region</Label>
              <Input id="s3Region" value={s3Region} onChange={(e) => setS3Region(e.target.value)} disabled={updateCluster.isPending} placeholder="garage" />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="s3AccessKey">Access Key ID</Label>
              <Input id="s3AccessKey" value={s3AccessKey} onChange={(e) => setS3AccessKey(e.target.value)} disabled={updateCluster.isPending} />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="s3SecretKey">Secret Access Key</Label>
              <Input id="s3SecretKey" type="password" value={s3SecretKey} onChange={(e) => setS3SecretKey(e.target.value)} disabled={updateCluster.isPending} />
            </div>
          </div>
        </section>
      )}
        ...
        <section className="space-y-4 rounded-lg border bg-card p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="grid gap-2">
              ...
              <Input id="awsRegion" value={s3Region} onChange={(e) => setS3Region(e.target.value)} disabled={updateCluster.isPending} />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="awsAccessKey">Access Key *</Label>
              <Input id="awsAccessKey" value={s3AccessKey} onChange={(e) => setS3AccessKey(e.target.value)} disabled={updateCluster.isPending} />
            </div>
            <div className="grid gap-2">
            ...
            <div className="grid gap-2">
              ...
              <Input id="awsEndpoint" value={adminUrl} onChange={(e) => setAdminUrl(e.target.value)} disabled={updateCluster.isPending} />
            </div>
          </div>
        </section>
      )}
        ...
        <section className="space-y-4 rounded-lg border bg-card p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="grid gap-2">
              ...
              <Input id="minioEndpoint" value={adminUrl} onChange={(e) => setAdminUrl(e.target.value)} disabled={updateCluster.isPending} placeholder="http://minio:9000" />
            </div>
            <div className="grid gap-2">
              <Label htmlFor="minioRegion">Region</Label>
              <Input id="minioRegion" value={s3Region} onChange={(e) => setS3Region(e.target.value)} disabled={updateCluster.isPending} placeholder="us-east-1" />
            </div>
            <div className="grid gap-2">
