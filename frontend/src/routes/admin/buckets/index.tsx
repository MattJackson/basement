...
export const Route = createFileRoute("/admin/buckets/")({
  component: adminPage(AdminBucketsAggregated),
});

function AdminBucketsAggregated() {
  ...
  if (error) {
    return (
      <div className="space-y-6">
        <PageHeader
          title="All Buckets"
          description="Aggregated bucket list across all clusters."
