...
```
opencode run -m example.com/qwen3.5 --dir /Users/mjackson/Developer/basement-ui "$(cat /tmp/worker_prompt.md)" &
```
...
2. Dispatch in background:
   ```
   opencode run -m example.com/qwen3.5 --dir /Users/mjackson/Developer/basement-ui "$(cat /tmp/v1_X_X_X_worker.md)" > /tmp/v1_X_X_X.log 2>&1 &
   ```
