...
```
opencode run -m example.com/qwen3.5 --dir /Users/mjackson/Developer/basement-ui "$(cat /Users/mjackson/Developer/basement-ui/prompts/<worker>.md)" > /tmp/<cycle>.log 2>&1 &
```
