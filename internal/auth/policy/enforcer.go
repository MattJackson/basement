...
type Enforcer interface {
	...
	// basement.example.com must not break when capability gates land, so the
...
// on basement.example.com's existing deployment).
...
// basement.example.com working when v0.9.0f's capability gates land. The
